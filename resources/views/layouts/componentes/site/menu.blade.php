    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark rounded ">
        ...
        <div class="collapse navbar-collapse " id="navbarTogglerDemo01">
            <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#"><font color="#fffff" ;=""><b>DOWNLOAD</b></font></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#" data-target="A"><font color="#fffff" ;=""><b>RANKING</b></font></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#"><font color="#fffff" ;=""><b>DOAÇÕES</b></font></a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="#"><font color="#fffff" ;=""><b>REGRAS</b></font></a>
                </li>
            </ul>
        </div>
    </nav>
